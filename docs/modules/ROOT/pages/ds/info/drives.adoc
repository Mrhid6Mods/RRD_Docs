...
The Tier 3 milestone lets you unlock the base item drive, the additional drive unlocks are under the DS tab of the MAM
...
== Drive Terminal
Setting up and partitioning drives are done using the Drive Terminal

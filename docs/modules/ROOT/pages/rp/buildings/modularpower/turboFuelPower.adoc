...
Next, get 540 m³/min of crude oil – in my example that's 2 extractors running @150%, one on a Pure node, the other on a Normal node.
...
Featured in the screenshots, the items you may not recognize from the base game include:

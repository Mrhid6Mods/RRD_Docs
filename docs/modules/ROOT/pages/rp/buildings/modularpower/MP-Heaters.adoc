...
=== Solution Heater
The Solution heater can produce 750{nbsp}℃ heat if fed with the following items:
|===
| Item   | Heat / Cycle | Item consumption rate | CO₂ production rate
...
| Rocketfuel |35|6{nbsp}m³|30{nbsp}m³
|===

The Solution heater can produce 1250{nbsp}℃ heat if fed with the following items:
|===
| Item   | Heat / Cycle | Item consumption rate | CO₂ production rate
...
| Ficsonium Fuel Rods|2{nbsp}500|0.667|None|0
|===

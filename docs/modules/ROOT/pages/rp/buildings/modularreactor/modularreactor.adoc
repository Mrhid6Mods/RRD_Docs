...
In Steam Mode the Reactor uses its internal heat to convert water into Compressed Steam to use in the Super HV Turbine
...
[NOTE]
====
These are very close values taken at the around start of the cycle, and will vary due to being heat-dependent and the fluctuations in the reactors internal heat.
====

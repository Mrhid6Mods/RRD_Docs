...
The first step is to make sure the Reactor Foundation is connected to the power grid with at least 100 MW.
Make sure its connected to a power pole and **NOT** a power storage.
...
You will see the middle light show green when all reactor chambers are locked.
( Please see below ).
